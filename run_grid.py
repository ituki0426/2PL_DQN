...
Grids (results go to results/<grid>/; section numbers refer to ../Paper/main.tex):
...
from catrl.irt import info
from catrl.rules import MEPVPolicy, MFIPolicy, WeightedInfoPolicy
...
def main():
    ...
    out = Path(args.out or (Path("results") / args.grid))
